/*
 * Create by KSH on 2021. 8. 17.
 * Copyright (c) 2021. KSH. All rights reserved.
 */

package com.ksh.jlibrosa;
...
import com.ksh.jlibrosa.process.AudioFeatureExtraction;
import com.ksh.jlibrosa.wavFile.WavFile;
...
public class JLibrosa {
	...
	private int noOfFrames = -1; // -1
	private int sampleRate = -1; // -1
	private int noOfChannels = -1;

	private double fMax = 44100 / 2.0;
	private double fMin = 0.0;
	private int n_fft = 2048; // 2048
	private int hop_length = 1024; // 512
	private int n_mels = 128; // 128 // 64
